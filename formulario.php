...
if ((isset($_POST['submit'])) && (!empty($_POST['submit']))) {
    ...
    $result = mysqli_query($conexao, "INSERT INTO usuarios (id, nome, email, rg, cpf, telefone, sexo, idade, logradouro, cidade, cep, bairro, numero, estado, senha) VALUES (NULL, '{$nome}','{$email}','{$rg}','{$cpf}','{$telefone}','{$genero}','{$idade}','{$logradouro}','{$cidade}','{$cep}','{$bairro}','{$numero}','{$estado}','{$senha}')");
